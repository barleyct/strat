...
function color() {
  ...
  function legend(svg) {
    ...
    var cellTrans = void 0,
        ...
        textVAlign = labelAlign == "inline" ? 1 : 0;
    ...
    if (orient === "vertical") {
      ...
      textTrans = function textTrans(d, i) {
        return "translate(" + (shapeSize[i].width * textAlign + shapeSize[i].x + textVAlign * labelOffset ) + ",\n          " + 
        ( (textVAlign ? 0 : (shapeSize[i].height + shapeSize[i].y)) + (textVAlign ? 5 : labelOffset) + 8) + ")";
      };
    }
  ...
  legend.labelAlign = function (_) {
    ...
    if (_ == "start" || _ == "end" || _ == "middle" || _ == "inline") {
      labelAlign = _;
    }
    return legend;
  };
